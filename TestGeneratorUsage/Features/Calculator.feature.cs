...
namespace TestGeneratorUsage.Features
{
...
#line hidden
        ...
        public CalculatorFeature(CalculatorFeature.FixtureData fixtureData, TestGeneratorUsage_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 8
 testRunner.Given("the first number is 52", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 9
